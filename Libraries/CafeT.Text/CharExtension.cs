...
namespace CafeT.Text
{
    ...
    {
        public static char[] EndOfWord = new char[] { ' ', '?', '!', ':', ';', '}', ']', ')', '>'};
        public static char[] EndOfSentence = new char[] { '!','?'};
        public static char[] OutOfWord = new char[] {
            '{', '}', '(', ')', '[', ']', '>', '<',
            '-', '_', '=', '+',
            '|', '\\', ':', ';', ' ', ',', '.', '/', '?', '~', '!',
            '@', '#', '$', '%', '^', '&', '*',
        ...
        {
            if (OutOfWord.Contains(c)) return true;
            return false;
        }
